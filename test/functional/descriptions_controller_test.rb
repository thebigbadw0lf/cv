...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { description_long: @description.description_long, description_short: @description.description_short }
    end
  ...
  test "should update description" do
    put :update, id: @description, description: { description_long: @description.description_long, description_short: @description.description_short }
    assert_redirected_to description_path(assigns(:description))
  end
