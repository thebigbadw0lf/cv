...
class JobTitlesControllerTest < ActionController::TestCase
  ...
  test "should create job_title" do
    assert_difference('JobTitle.count') do
      post :create, job_title: { id: @job_title.id, title_long: @job_title.title_long, title_short: @job_title.title_short }
    end
  ...
  test "should update job_title" do
    put :update, id: @job_title, job_title: { id: @job_title.id, title_long: @job_title.title_long, title_short: @job_title.title_short }
    assert_redirected_to job_title_path(assigns(:job_title))
  end
