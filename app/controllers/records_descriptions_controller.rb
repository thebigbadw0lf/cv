class RecordsDescriptionsController < ApplicationController
  ...
  def index
    @records_descriptions = RecordsDescriptions.all
  ...
  def show
    @records_description = RecordsDescriptions.find(params[:id])
  ...
  def new
    @records_description = RecordsDescriptions.new
  ...
  def create
    @records_description = RecordsDescriptions.new(params[:records_description])

    respond_to do |format|
      if @records_description.save
        format.html { redirect_to @records_description, notice: 'Records descriptions was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @records_description.update_attributes(params[:records_description])
        format.html { redirect_to @records_description, notice: 'Records descriptions was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to records_descriptions_index_url }
      format.json { head :no_content }
    end
  end
end
